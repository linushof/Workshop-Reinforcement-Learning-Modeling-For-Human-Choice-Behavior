...
for (block in 1:Nblocks){
  ...
  for (trial in 1:Ntrials_perblock){
    ...
    state2  = choice1
    p_2     = exp(beta*Qval[, ______, 2]) / sum(exp(beta*Qval[, ______, 2]))
    ...
    PE_2 = Qval[choice3, state3, 3] - Qval[______, ______, ______]
    PE_3 = ______ - Qval[choice3, state3, 3]
    ...
    Qval[choice3, state3, 3] = Qval[choice3, state3, 3] + ______*PE_3
