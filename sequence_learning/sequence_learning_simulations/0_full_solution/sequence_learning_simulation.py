...
for block in range(1, Nblocks + 1):
    ...
    for trial in range(1, Ntrials_perblock + 1):
        ...
        choice3 = np.random.choice(np.arange(1, 3), p=p_3)
        ...
        PE_2 = Qval[choice3 - 1, state3 - 1, 2] - Qval[choice2 - 1, state2 - 1, 1]
        PE_3 = reward - Qval[choice3 - 1, state3 - 1, 2]
        
        Qval[choice1 - 1, state1 - 1, 0] += alpha * PE_1 + alpha * lambda_ * PE_2 + alpha * (lambda_ ** 2) * PE_3
        Qval[choice2 - 1, state2 - 1, 1] += alpha * PE_2 + alpha * lambda_ * PE_3
        Qval[choice3 - 1, state3 - 1, 2] += alpha * PE_3
