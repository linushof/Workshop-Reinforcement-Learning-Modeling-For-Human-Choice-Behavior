...
model_parameters$names                             =c('beta','alpha','lambda','omega')
model_parameters$transformation                    =c('none','beta','beta','beta')
model_parameters$artificial_population_location    =c(3,0.5,0.5,0.5)
model_parameters$artificial_population_scale       =c(1,0.15,0.15,0.15)
