library(dplyr)
rndwlk = read.csv('R/functions/rndwlk.csv',header=F)
...
parameters=c(0.3,0.7,3,1) #change the fourth parameter

#### simulate Rescorla-Wagner block for participant ----
sim.block = function(parameters,cfg){ 
