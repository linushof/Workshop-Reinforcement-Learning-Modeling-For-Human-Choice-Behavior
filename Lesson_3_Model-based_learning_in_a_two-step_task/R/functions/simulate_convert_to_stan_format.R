simulate_convert_to_standata <-function (path,cfg,var_toinclude){
  ...
  source('two_step_task/R/functions/make_mystandata.R')
  ...
  write(json_data, file = paste0('two_step_task/R/data/stan_ready_data_files/artificial_standata_', path$name, '.json'))
  #save
  save(data_for_stan,file=paste0('two_step_task/R/data/stan_ready_data_files/artificial_standata_', path$name, '.Rdata'))
